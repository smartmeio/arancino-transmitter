...
class ArancinoPostInstallCommand(install):
    ...
    def run(self):
        ...
        print("--------------------------------------")
        print("START ARANCINO TRANSMITTER PRE INSTALL")
        call(["extras/pre-install.sh"])
        print("END ARANCINO TRANSMITTER PRE INSTALL")
        print("--------------------------------------")

        #### ARANCINO INSTALL
        print("--------------------------------------")
        print("START ARANCINO TRANSMITTER INSTALL")
        install.run(self)
        print("END ARANCINO TRANSMITTER INSTALL")
        print("--------------------------------------")

        #### ARANCINO POST INSTALL
        print("--------------------------------------")
        print("START ARANCINO TRANSMITTER POST INSTALL")
        call(["extras/post-install.sh"])
        print("END ARANCINO TRANSMITTER POST INSTALL")
        print("--------------------------------------")
